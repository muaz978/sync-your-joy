...
- The prior `v0.1.18` package was downloaded and checksum-verified. The `v0.1.19` candidate is the build intended for the next friend test after release verification.
